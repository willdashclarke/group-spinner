              ...
              {showBulkImport && (
                <div className="mt-3 p-4 bg-slate-50 rounded-lg border">
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    Paste multiple names (one per line, or separated by commas)
                  </label>
                  <textarea
                    className="w-full h-32 border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
                    value={bulkText}
